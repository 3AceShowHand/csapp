...
0000000000400ebc <call_gmon_start>:
  ...
  400ec0:       48 8b 05 19 31 20 00    mov    0x203119(%rip),%rax        # 603fe0 <_DYNAMIC+0                                                                                                 x1d0>
...
0000000000400f70 <frame_dummy>:
  400f70:       48 83 3d 90 2e 20 00    cmpq   $0x0,0x202e90(%rip)        # 603e08 <__JCR_END_                                                                                                 _>
  400f77:       00
...
000000000040102a <initialize_target>:
  ...
  401048:       89 3d 8a 34 20 00       mov    %edi,0x20348a(%rip)        # 6044d8 <check_leve                                                                                                 l>
  ...
  4010be:       c6 05 43 40 20 00 63    movb   $0x63,0x204043(%rip)        # 605108 <target_pr                                                                                                 efix>
...
00000000004011ad <main>:
  ...
  401214:       48 8b 05 85 32 20 00    mov    0x203285(%rip),%rax        # 6044a0 <stdin@@GLI                                                                                                 BC_2.2.5>
  ...
  401255:       48 8b 3d 4c 32 20 00    mov    0x20324c(%rip),%rdi        # 6044a8 <optarg@@GL                                                                                                 IBC_2.2.5>
  ...
  401271:       48 8b 0d 30 32 20 00    mov    0x203230(%rip),%rcx        # 6044a8 <optarg@@GL                                                                                                 IBC_2.2.5>
  401278:       ba b2 2f 40 00          mov    $0x402fb2,%edx
  40127d:       be 01 00 00 00          mov    $0x1,%esi
  401282:       48 8b 3d 27 32 20 00    mov    0x203227(%rip),%rdi        # 6044b0 <stderr@@GL                                                                                                 IBC_2.2.5>
  ...
  4012a2:       48 8b 3d ff 31 20 00    mov    0x2031ff(%rip),%rdi        # 6044a8 <optarg@@GL                                                                                                 IBC_2.2.5>
  ...
  4012bd:       48 8b 3d e4 31 20 00    mov    0x2031e4(%rip),%rdi        # 6044a8 <optarg@@GL                                                                                                 IBC_2.2.5>
...
0000000000401a0b <check_fail>:
  ...
  401a0f:       0f be 15 f2 36 20 00    movsbl 0x2036f2(%rip),%edx        # 605108 <target_pre                                                                                                 fix>
  401a16:       41 b8 00 45 60 00       mov    $0x604500,%r8d
  401a1c:       8b 0d b6 2a 20 00       mov    0x202ab6(%rip),%ecx        # 6044d8 <check_leve                                                                                                 l>
...
0000000000401a92 <notify_server>:
  ...
  401aea:       0f be 15 17 36 20 00    movsbl 0x203617(%rip),%edx        # 605108 <target_pre                                                                                                 fix>
...
0000000000401c8d <validate>:
  ...
  401cb5:       8b 15 1d 28 20 00       mov    0x20281d(%rip),%edx        # 6044d8 <check_leve                                                                                                 l>
  ...
  401cdf:       0f be 15 22 34 20 00    movsbl 0x203422(%rip),%edx        # 605108 <target_pre                                                                                                 fix>
  ...
  401d24:       0f be 0d dd 33 20 00    movsbl 0x2033dd(%rip),%ecx        # 605108 <target_pre                                                                                                 fix>
...
0000000000401eb4 <launch>:
  ...
  401eec:       48 8b 05 ad 25 20 00    mov    0x2025ad(%rip),%rax        # 6044a0 <stdin@@GLI                                                                                                 BC_2.2.5>
...
0000000000401f61 <stable_launch>:
  401f61:       53                      push   %rbx
  401f62:       48 89 3d 5f 25 20 00    mov    %rdi,0x20255f(%rip)        # 6044c8 <global_off                                                                                                 set>
  ...
  401fb5:       48 8b 3d f4 24 20 00    mov    0x2024f4(%rip),%rdi        # 6044b0 <stderr@@GL                                                                                                 IBC_2.2.5>
  ...
  401fe7:       48 89 15 d2 24 20 00    mov    %rdx,0x2024d2(%rip)        # 6044c0 <global_sav                                                                                                 e_stack>
  401fee:       48 8b 3d d3 24 20 00    mov    0x2024d3(%rip),%rdi        # 6044c8 <global_off                                                                                                 set>
  401ff5:       e8 ba fe ff ff          callq  401eb4 <launch>
  401ffa:       48 8b 05 bf 24 20 00    mov    0x2024bf(%rip),%rax        # 6044c0 <global_sav                                                                                                 e_stack>
...
0000000000402032 <sigalrm_handler>:
  ...
  402045:       48 8b 3d 64 24 20 00    mov    0x202464(%rip),%rdi        # 6044b0 <stderr@@GL                                                                                                 IBC_2.2.5>
...
0000000000402ce0 <__libc_csu_init>:
  ...
  402cea:       48 8d 2d 0f 11 20 00    lea    0x20110f(%rip),%rbp        # 603e00 <__init_arr                                                                                                 ay_end>
  402cf1:       4c 8d 25 00 11 20 00    lea    0x201100(%rip),%r12        # 603df8 <__frame_du                                                                                                 mmy_init_array_entry>
